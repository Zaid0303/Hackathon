...
if (isset($_POST['submit'])) {
    ...
    if (!empty($brand_name) && !empty($contact_email) && !empty($contact_phone)  && !empty($registration_date)) {

        // Insert query
        $insert_brand = "INSERT INTO `brands` (`ngo_id`, `brand_name`, `contact_email`, `contact_phone`,  `registration_date`) 
        VALUES (NULL, '$brand_name', '$contact_email', '$contact_phone', '$registration_date')";

        $connect = mysqli_query($connection, $insert_brand);
